# Build (if needed), install Playwright Chromium if needed, then zip all Refiner tab screenshots to artifacts/refiner-ui-tabs.zip
$ErrorActionPreference = "Stop"
$repoRoot = Split-Path -Parent $PSScriptRoot
$py = Join-Path $repoRoot "apps\backend\.venv\Scripts\python.exe"
$script = Join-Path $repoRoot "scripts\capture_refiner_ui_zip.py"
...
$zip = Join-Path $repoRoot "artifacts\refiner-ui-tabs.zip"
Write-Host ""
