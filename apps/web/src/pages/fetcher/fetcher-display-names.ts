...
export const FETCHER_CONNECTION_PANEL_RADARR = "Radarr";

export const FETCHER_SAVE_SONARR = "Save Sonarr";
export const FETCHER_SAVE_RADARR = "Save Radarr";
export const FETCHER_TEST_SONARR = "Test Sonarr";
export const FETCHER_TEST_RADARR = "Test Radarr";
