...
from mediamop.modules.fetcher.fetcher_arr_connection_crypto import decrypt_arr_api_key
...
def preview_sonarr_http_credentials_after_put(
    ...
    *,
    ...
    """What ``resolve_sonarr_http_credentials`` would return after ``apply_fetcher_arr_connection_put_sonarr``, without writing."""
...
def preview_radarr_http_credentials_after_put(
    ...
    *,
    ...
    """What ``resolve_radarr_http_credentials`` would return after ``apply_fetcher_arr_connection_put_radarr``, without writing."""
