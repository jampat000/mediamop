"""Wall-clock schedule windows for Fetcher Arr search lanes (IANA timezone).

Used only by missing/upgrade search handlers; each lane passes its own enabled/days/start/end
from :class:`~mediamop.core.config.MediaMopSettings` (see ADR-0009).
"""
...
def fetcher_arr_search_schedule_in_window(
    *,
