# ADR-0011: Fetcher failed-import queue delete — upstream contract vs MediaMop

## Status

**ADR:** Accepted — source review of Sonarr/Radarr `develop` branches as of audit date; complements ADR-0010 (internal taxonomy).

**Fetcher failed-imports (this contract):** **Complete — subject to live prod testing/signoff.** Source and in-repo audits are not a substitute for running against your installed Sonarr/Radarr versions, real queue data, and real download clients.
...
- Fetcher failed-import **architecture** and in-process wiring.
